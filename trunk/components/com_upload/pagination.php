...
class pagination {
    ...
    public function get_html() {
        ...
        if ($this->page == $Page_num) {
            ...
            $NextPage = "<li class=\"pagination-next\"><a class=\"pagenav\" href=\"". $this->url . ($this->page + 1) . "\"title=\"Next\">Next</a></li>";
            $Last = "<li class=\"pagination-end last\"><a class=\"pagenav\" href=\"". $this->url . $Page_num ."\" title=\"End\">End</a></li></ul>";
...
<div class="k2Pagination">
    <ul>
        ...
        <li><a class="pagenav" href="/joomla_37537/index.php/news?start=3" title="2">2</a></li>
        <li class="pagination-next"><a class="pagenav" href="/joomla_37537/index.php/news?start=3" title="Next">Next</a></li>
        <li class="pagination-end last"><a class="pagenav" href="/joomla_37537/index.php/news?start=3" title="End">End</a></li></ul>		
        <div class="clr"></div>
</div>-->